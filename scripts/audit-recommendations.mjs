...
const auditCases = [
  ...
  {
    label: "Lucian mixed-loop baseline",
    championId: "Lucian",
    augmentIds: ["46", "54", "87"],
    expectedTopAugmentId: "46",
    minimumVerdict: "strong_pick",
  },
  {
    label: "Kaisa conversion baseline",
    championId: "Kaisa",
    augmentIds: ["206", "205"],
    expectedTopAugmentId: "206",
    minimumVerdict: "strong_pick",
  },
  {
    label: "Kaisa executioner vs all-for-you",
    championId: "Kaisa",
    augmentIds: ["32", "141"],
    expectedTopAugmentId: "32",
    disallowedTopAugmentIds: ["141"],
    minimumVerdict: "good_pick",
  },
  {
    label: "Kaisa executioner vs slap-around",
    championId: "Kaisa",
    augmentIds: ["32", "136"],
    expectedTopAugmentId: "32",
    disallowedTopAugmentIds: ["136"],
    minimumVerdict: "good_pick",
  },
  {
    label: "Kaisa support-cc mismatch baseline",
    championId: "Kaisa",
    augmentIds: ["32", "141", "136"],
    expectedTopAugmentId: "32",
    disallowedTopAugmentIds: ["141", "136"],
    minimumVerdict: "good_pick",
  },
  {
    label: "Aatrox drain-frontline baseline",
    championId: "Aatrox",
    augmentIds: ["138", "64", "60"],
    expectedTopAugmentId: "138",
    minimumVerdict: "strong_pick",
  },
  {
    label: "KogMaw on-hit baseline",
    championId: "KogMaw",
    augmentIds: ["87", "51", "84"],
    expectedTopAugmentIds: ["87", "51"],
    disallowedTopAugmentIds: ["84"],
    minimumVerdict: "strong_pick",
  },
  {
    label: "Darius executioner baseline",
    championId: "Darius",
    augmentIds: ["32", "64", "141"],
    expectedTopAugmentId: "32",
    minimumVerdict: "strong_pick",
  },
  {
    label: "Kaisa dashing baseline",
    championId: "Kaisa",
    augmentIds: ["19", "205", "141"],
    expectedTopAugmentId: "19",
    minimumVerdict: "strong_pick",
  },
  {
    label: "Leona colossus baseline",
    championId: "Leona",
    augmentIds: ["18", "64", "138"],
    expectedTopAugmentId: "18",
    minimumVerdict: "strong_pick",
  },
  {
    label: "Pyke executioner baseline",
    championId: "Pyke",
    augmentIds: ["32", "19", "141"],
    expectedTopAugmentId: "32",
    disallowedTopAugmentIds: ["141"],
    minimumVerdict: "strong_pick",
  },
  {
    label: "Qiyana skirmish baseline",
    championId: "Qiyana",
    augmentIds: ["19", "32", "141"],
    expectedTopAugmentIds: ["19", "32"],
    disallowedTopAugmentIds: ["141"],
    minimumVerdict: "strong_pick",
  },
  {
    label: "Akali dashing baseline",
    championId: "Akali",
    augmentIds: ["19", "32", "141"],
    expectedTopAugmentId: "19",
    disallowedTopAugmentIds: ["141"],
  ...
  {
    label: "Khazix executioner baseline",
    championId: "Khazix",
    augmentIds: ["32", "19", "141"],
    expectedTopAugmentId: "32",
    disallowedTopAugmentIds: ["141"],
